...
\subsection{.bashrc}
\lstinputlisting[language=Bash]{code/miscellaneous/.bashrc}
...
\lstinputlisting{code/data_structures/segment_tree.cpp}

\subsection{Segment Tree on Trees}
\lstinputlisting{code/data_structures/segment_tree_on_trees.cpp}
...
\subsection{SCC's}
\lstinputlisting{code/graph_algorithms/scc.cpp}
...
\lstinputlisting{code/mathematics/mod_multiplication.cpp}

\subsection{Miller Rabin - Primality Testing}
\lstinputlisting{code/mathematics/miller_rabin.cpp}

\subsection{Prime Factorisation}
\lstinputlisting{code/mathematics/factor.cpp}
...
\lstinputlisting{code/mathematics/chinese_remainder_theorem.cpp}

\subsection{Euler's Totient Function}
\lstinputlisting{code/mathematics/euler_totient.cpp}
